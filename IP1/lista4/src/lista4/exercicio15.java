...
Lista 4
Almir
15.Dois carros percorreram diferentes distâncias em diferentes tempos.
...
public class exercicio15 {
    public static void main(String[] args) {
        ...
        if (vm_1 > vm_2) {
            System.out.printf("O carro 1 obteve a maior velocidade média %.2f\n",vm_1);
        } else if (vm_2 > vm_1){
            System.out.printf("O carro 2 obteve maior velocidade média %.2f \n",vm_2);
        } else {
