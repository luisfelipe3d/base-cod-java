...
public class exercicio2 {
    public static void main(String[] args) {
        ...
        if (media >= 7)
            System.out.printf("O aluno obteve media %.2f e está Aprovado.\n",media);
        else if (media <7 && media >=3)
            System.out.printf("O aluno obteve media %.2f e está em Recuperação.\n",media);
        else
            System.out.printf("O aluno obteve media %.2f está Reprovado.",media);
